									...
									<li class="{{ strtolower($product->lists->type) }}">
										...
										<div class="each-col">
											<ul class="ctas">
												...
												<li><a href="{{ route('favourite.store') }}" data-list-id="{{ $product->lists->id }}" class="favourite"><i class="add-to-favourite"></i> <span>Add to favourites</span></a></li>
